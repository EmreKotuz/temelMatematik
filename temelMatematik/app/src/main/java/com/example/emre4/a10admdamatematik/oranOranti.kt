...
import kotlinx.android.synthetic.main.activity_oran_oranti.*
...
class oranOranti : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        geceOranMod.setOnClickListener {
            if (geceOranMod.isChecked){
                geceOranMod.text="Gece modunu kapatmak için tıklayınız"
                geceOranEkran.setBackgroundColor(Color.parseColor("#6ADBC83D"))
            }
            else{
                geceOranMod.text="Gece Modu"
                geceOranEkran.setBackgroundColor(Color.WHITE)
        ...
        mInterstitialAd = InterstitialAd(this).apply {
            ...
            adListener = (object : AdListener() {
                ...
                override fun onAdClosed() {
                    ...
                    anaSayfaButton5.text = "Tekrar İzle"
        ...
        anaSayfaButton5.setOnClickListener { showInterstitial() }
