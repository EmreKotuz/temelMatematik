...
import kotlinx.android.synthetic.main.activity_rasyonel.*

class rasyonel : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mInterstitialAd = InterstitialAd(this).apply {
            ...
            adListener = (object : AdListener() {
                ...
                override fun onAdClosed() {
                    ...
                    anaSayfaButton2.text = "Tekrar İzle"
        ...
        anaSayfaButton2.setOnClickListener { showInterstitial() }
