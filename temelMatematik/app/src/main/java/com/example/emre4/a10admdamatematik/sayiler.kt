...
const val AD_UeNIT_eIDae = "ca-app-pub-6537190103014639/3660365681"
...
class sayiler : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sayiGeceModu.setOnClickListener {
            if (sayiGeceModu.isChecked){
                sayiGeceModu.text="Gece modunu kapatmak için tıklayınız"
                geceSayiEkran.setBackgroundColor(Color.parseColor("#6ADBC83D"))
            }
            else{
                sayiGeceModu.text="Gece Modu"
                geceSayiEkran.setBackgroundColor(Color.WHITE)
        ...
        mInterstitialAd = InterstitialAd(this).apply {
            ...
            adListener = (object : AdListener() {
                ...
                override fun onAdClosed() {
                    ...
                    anaSayfaButton1.text="Tekrar İzle"
        ...
        anaSayfaButton1.setOnClickListener { showInterstitial() }
