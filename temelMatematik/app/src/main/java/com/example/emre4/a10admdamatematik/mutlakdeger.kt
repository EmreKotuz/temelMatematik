...
import kotlinx.android.synthetic.main.activity_mutlakdeger.*
...
class mutlakdeger : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mutlakdeger)

        mutlakGeceModu.setOnClickListener {
            if (mutlakGeceModu.isChecked){
                mutlakEkran.setBackgroundColor(Color.parseColor("#6ADBC83D"))
        ...
        mInterstitialAd = InterstitialAd(this).apply {
            ...
            adListener = (object : AdListener() {
                ...
                override fun onAdClosed() {
                    ...
                    anaSayfaButton4.text = "Tekrar İzle"
        ...
        anaSayfaButton4.setOnClickListener { showInterstitial() }
